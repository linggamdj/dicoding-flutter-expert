...
class _HomeMoviePageState extends State<HomeMoviePage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() {
      context.read<NowPlayingMovieBloc>().add(OnNowPlayingMoviesHasData());
      context.read<PopularMovieBloc>().add(OnPopularMoviesHasData());
      context.read<TopRatedMovieBloc>().add(OnTopRatedMoviesHasData());
    });
  }
